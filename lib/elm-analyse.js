...
export default class ElmAnalyse {
  ...
  disconnect() {
    this.elmAnalyseEditorListener();
    this.elmAnalyseEditorListener = null;
  ...
  connectToElmAnalyse(info, port) {
    ...
    this.elmAnalyseEditor = ElmAnalyseEditor(port);
    this.elmAnalyseEditorListener = this.elmAnalyseEditor.onState(state =>
      this.processElmAnalyseMessage(info, state)
    );
    this.elmAnalyseEditor.start();
    return this.elmAnalyseEditor;
  }
